...
ca = set()
cc = set()
PORT = json.load("SERVER_PORT")
IP = json.load("SERVER_HOST")
...
class server_relient_commands:
    ...
    def set_vars(self, name, command, client_socket, client_address, color):
        self.commands = {"/List" : self.List, "/Quit" : self.Quit_Current_Clinet, "/Start Game" : Games, "/Name" : self.Name, "/Credits" : self.Credits} # update this as needed to make more commandsd
        self.name = name
...
def choose_color(colors):
    # TO DO change to better system later
